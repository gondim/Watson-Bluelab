...
module.exports = function(io, speech_to_text) {
  ...
  io.on('connection', function(socket) {
    ...
    socket.on('message', function(data) {
      ...
      if (!session.open) {
        ...
        session.req = speech_to_text.recognizeLive(payload, observe_results(socket, true));
        // GET /observeResult to get live transcripts
        speech_to_text.observeResult(payload, observe_results(socket, false));
    ...
    socket.on('disconnect', function() {
      speech_to_text.deleteSession(session, function() {
